        ...
        <div className="border-t border-gray-200">
                  ...
                  <div className="mt-2">
                    <div className="flex items-center">
                      ...
                      <div className="w-3/5 pl-4">
                        ...
                        <div className="text-2xl font-bold text-gray-900">{report.result.reliabilityScore}/5.0</div>
                      </div>
                    </div>
                    <div className="mt-4">
          ...
          {report.status === "processing" && (
            <div className="px-4 py-5 sm:p-6 text-center">
              <div className="animate-spin mx-auto h-10 w-10 text-lemon-500 border-4 border-current border-t-transparent rounded-full"></div>
